...
const ShowBooks = () => {
  ...
  const { id } = useParams(); // A parameter from other components used here with the help of usePArams
  ...
  return (
    <div className="p-4 font-bold bg-cover h-screen w-full" style={{backgroundImage:`url(${images})`}}>
      ...
      {loading ? (
        ...
        <div className="flex flex-col border-2 border-sky-400  w-fit p-4 rounded-xl">
          <div className="my-4">
